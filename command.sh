...
# --num-epochs 200 --lr 0.001 --lr-factor 0.333 --lr-callback 1 --lr-byepoch 30 --optimizer adam --dropout 0 --pooling max
# done
...
# do 
# python s-igc.py --network igc1 --depth 5 --firstgroup 4 --secondgroup 3 --dataset indian_pines --spatial-size 7 --bf 0 --train-scale 0.3 --batch-size 32 \
# --num-epochs 200 --lr 0.001 --lr-factor 0.333 --lr-callback 1 --lr-byepoch 30 --optimizer adam --dropout 0.2 --pooling max
# done
...
--num-epochs 130 --lr 0.001 --lr-factor 0.333 --lr-callback 1 --lr-byepoch 30 --optimizer adam --dropout 0 --pooling max